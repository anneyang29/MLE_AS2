...
def main(snapshotdate, modelname):
    ...
    try: 
        ...
        config["model_artefact_filepath"] = config["model_name"]
        ...
        partition_name = config["model_name"].split("/")[-1] + "_preds_" + config["snapshot_date_str"].replace('-','_') + '.parquet'
...
if __name__ == "__main__":
    ...
    print("Running inference script with command-line arguments...")
